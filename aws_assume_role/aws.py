...
def assume_aws_role(sts_connection, role_arn, role_session_name,
...
def set_shell_environment_variables(access_key, secret_key, session_token,
    ...
    print "export AWS_SECRET_ACCESS_KEY={};".format(pipes.quote(
                                                    str(secret_key)))
    print "export AWS_SESSION_TOKEN={};".format(pipes.quote(
                                                str(session_token)))
    print "export AWS_DEFAULT_REGION={};".format(pipes.quote(str(region)))
    print "export AWS_SESSION_NAME={};".format(pipes.quote(
                                               str(session_name)))
    print "export AWS_SESSION_EXPIRATION={};".format(pipes.quote(
                                                     str(expiration)))
